...
app.post("/api/user/update-patient",upload.single("patient_attachment"),async (req,res)=>{
...
app.post("/api/user/add-appointment-slot", (req, res)=>{
    ...
    let coDoctorId = typeof req.body.co_doctor === 'undefined' ? null : req.body.co_doctor
...
app.post("/api/user/use-appointment-slot",upload.single('payment_attachment'),(req, res)=>{
