...
export class Patient{
	constructor(id, patient_name, animal_type, breed, gender, weight, is_sterilized, description, birthdate, pet_owner, picture) {
		this.id=id
...
export class VisitReminder{
	constructor(id, booking_type_name, description, create_date, target_send_date, patient_id) {
		this.id=id
